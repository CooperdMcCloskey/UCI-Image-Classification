...
is_day = time == 'day'
debugging = True # adds logs

# image processing
image_size = (224, 224) # downsizes the images appropriately while maintaining aspect ratio
noise_reduction_threshold = 0.05 # when the background is removed from the image, all pixels less than the threshold will be set to 0

# training (go to training/model.py to configure the actual model structure)
batch_size =24
epochs = 30
data_shuffle_buffer_size = 1000 

# include folders here
training_data_paths = [
  'data/2022_11_09_BonitaCanyon1',
